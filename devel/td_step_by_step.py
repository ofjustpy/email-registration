...
# _ss.inputbox_first_name.target.value = "sxsdsdfs"
# _ss.inputbox_last_name.target.value = "mypass1"
# _ss.inputbox_password.target.value = "mypass1"
# _ss.inputbox_confirm_password.target.value = "mypass1"
...
async def main():
    ...
    page_source = conn.root.load_page("http://127.0.0.1:8000/", "register_new_user")
    #print (page_source)
    res = conn.root.set_value_element("/inputbox_email", "spoofemail@monallabs.in")
    print ("res = ", res)
        
    res = conn.root.set_value_element("/inputbox_first_name", "sxsdsdfs")
    print ("res = ", res)
    
    res = conn.root.set_value_element("/inputbox_password", "mypass1")
    print ("res = ", res)
    
    res = conn.root.set_value_element("/inputbox_confirm_password", "mypass1")
    print ("res = ", res)
